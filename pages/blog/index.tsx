...
const BlogIndex = ({ allPostsData }: BlogIndexProps) => {
    return (
        <>
            <Head>
                <title>Blog | Gold Crown Africa</title>
                <meta
                    name="description"
                ...
                <div className="py-24">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg leading-8 text-gray-600 max-w-2xl mx-auto dark:text-gray-400">
                            Stay updated with the latest trends in the gold and diamond industry across Africa and beyond.
                        </p>
                    </div>

                    <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                        {allPostsData.map((post) => (
                            <div key={post.slug} className="group relative flex flex-col items-start bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition dark:bg-trueGray-900 dark:border-trueGray-800">
                                ...
                                <Link href={`/blog/${post.slug}`} className="mt-6 flex items-center gap-x-1 text-sm font-medium text-indigo-600 dark:text-indigo-400">
                                    Read more

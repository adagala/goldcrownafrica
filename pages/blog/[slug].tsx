                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="mt-16 pt-10 border-t border-gray-100 dark:border-trueGray-800">
                            <div className="bg-indigo-50 rounded-3xl p-8 sm:p-12 text-center dark:bg-trueGray-900">
                                <h2 className="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">Want more insights?</h2>
                                <p className="text-gray-600 mb-8 dark:text-gray-400">
                                    Contact us today to learn more about our services and how we can help you in the precious metals market.
                                </p>
                                <a href="/contact" className="inline-flex items-center justify-center px-8 py-3 font-medium text-white bg-indigo-600 rounded-full hover:bg-indigo-700 transition dark:bg-indigo-600 dark:hover:bg-indigo-500">
                                    Get in Touch
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="mt-12 text-center">
                            <a href="/blog" className="text-indigo-600 font-medium hover:text-indigo-500 inline-flex items-center gap-2 dark:text-indigo-400">
